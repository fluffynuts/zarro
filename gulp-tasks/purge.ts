(function() {
    const
        ...
        { rmSync, lsSync, FsEntities, folderExistsSync } = require("yafs"),
    ...
    function listPurgeDirs(...varNames: string[]): string[] {
