...
describe(`searchPackages`, () => {
    ...
    it(`should find packages at github`, async () => {
        ...
        const githubSource = availableSources.find(o => o.name == "github-codeo");
        if (!githubSource) {
    ...
    it(`should not include pre-release packages by default`, async () => {
        ...
        // Assert
        const firstPreRelease = result.find(o => o.version.isPreRelease);
    ...
    describe(`paging`, () => {
        it(`should page on request`, async () => {
            ...
            const result1 = await searchPackages(Object.assign(Object.assign({}, opts), { take: 1, skip: 0 }));
            const result2 = await searchPackages(Object.assign(Object.assign({}, opts), { take: 1, skip: 1 }));
            // Assert
            expect(result1[0])
