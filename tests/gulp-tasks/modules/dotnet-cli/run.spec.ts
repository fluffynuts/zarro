...
const
  ...
  { run } = requireModule<DotNetCli>("dotnet-cli");
  ...
  describe(`unit testing`, () => {
    ...
    it(`should use the provided configuration`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--configuration", configuration ],
          anything
        );
    });
    ...
    it(`should use provided framework`, async () => {
      // Arrange
      const
        framework = faker.string.alphanumeric(),
        target = faker.system.fileName();
      // Act
      await run({
        target,
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--framework", framework ],
          anything
        );
    });
    ...
    it(`should use provided runtime`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--runtime", runtime ],
          anything
        );
    });
    ...
    it(`should use the provided launch profile`, async () => {
      // Arrange
      const
        launchProfile = faker.string.alphanumeric(),
        target = faker.system.fileName();
      // Act
      await run({
        target,
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--launch-profile", launchProfile ],
          anything
        );
    });
    ...
    it(`should disable launch profiles on demand`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--no-launch-profile" ],
          anything
        );
    });
    ...
    it(`should enable interactivity on demand`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--interactive" ],
          anything
        );
    });
    ...
    it(`should disable self-contained on demand`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--no-self-contained" ],
          anything
        );
    });
    ...
    it(`should enable self-contained on demand`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--self-contained" ],
          anything
        );
    });
    ...
    it(`should disable build servers on demand`, async () => {
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--disable-build-servers" ],
          anything
        );
    });
    ...
    it(`should use the provided artifacts path`, async () => {
      // Arrange
      const
        artifactsPath = faker.string.alphanumeric(),
        target = faker.system.fileName();
      // Act
      await run({
        target,
      ...
      expect(system)
        .toHaveBeenCalledOnceWith(
          "dotnet",
          [ "run", "--project", target, "--artifacts-path", artifactsPath ],
          anything
        );
    });
