...
describe(`path-utils`, () => {
    describe(`splitPath`, () => {
        const { splitPath } = requireModule("path-utils");
        ...
        describe(`safe-guarding js calls`, () => {
            ...
            it(`should return empty array for undefined`, async () => {
                // Arrange
                // Act
                const result = splitPath(undefined);
                // Assert
                expect(result)
                    .toBeEmptyArray();
            });
    ...
    describe(`baseName`, () => {
        const { baseName } = requireModule("path-utils");
        it(`should be a function`, async () => {
            // Arrange
            // Act
            expect(baseName)
    ...
    describe(`chopExtension`, () => {
        const { chopExtension } = requireModule("path-utils");
        it(`should be a function`, async () => {
            // Arrange
            // Act
        ...
        describe(`safe-guarding js calls`, () => {
            it(`should return empty string for null`, async () => {
                // Arrange
                // Act
                const result = chopExtension(null);
                // Assert
                expect(result)
                    .toBeEmptyString();
            });
            it(`should return empty string for undefined`, async () => {
                // Arrange
                // Act
                const result = chopExtension(undefined);
                // Assert
                expect(result)
                    .toBeEmptyString();
            });
