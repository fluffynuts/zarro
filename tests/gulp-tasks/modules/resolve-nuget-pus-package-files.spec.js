...
describe(`resolve-nuget-pus-package-files`, () => {
    ...
    describe(`when ${env.NUGET_PUSH_PACKAGES} is defined`, () => {
        it(`should return named relative package under the packages folder`, async () => {
            // Arrange
            const sandbox = await filesystem_sandbox_1.Sandbox.create(), packFolder = env.resolve(env.PACK_TARGET_FOLDER), package1 = "foo.bar.nupkg", package1Symbols = "foo.bar.symbols.nupkg", package2 = "quux.cow.nupkg", 
            // force an ambiguity
