...
describe(`update-nuspec-version`, () => {
    const sut = requireModule("update-nuspec-version");
    ...
    it(`should update the version in the file`, async () => {
        // Arrange
        const sandbox = await filesystem_sandbox_1.Sandbox.create(), nuspec = await sandbox.writeFile("Package.nuspec", packageNuspec), expected = "1.2.3-foo.bar";
        // Act
