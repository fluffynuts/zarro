...
describe(`linq`, () => {
  const { first, last, skip, take } = requireModule<Linq>("linq");
  describe(`last`, () => {
    ...
    describe(`given array of items`, () => {
      it(`should return the last item`, async () => {
        // Arrange
        const
          w1 = faker.word.sample(),
          w2 = faker.word.sample(),
          w3 = faker.word.sample(),
          arr = [ w1, w2, w3 ];
        // Act
  ...
  describe(`skip`, () => {
    describe(`given null`, () => {
      it(`should provide empty iterator`, async () => {
        // Arrange
        // Act
        const result = Array.from(skip(null as unknown as any[], 2));
        // Assert
        expect(result)
          .toBeEmptyArray();
      });
  ...
  describe(`take`, () => {
    describe(`given null`, () => {
      it(`should return empty array`, async () => {
        // Arrange
        // Act
        const result = Array.from(take(null as unknown as any[], 2));
        // Assert
        expect(result)
          .toBeEmptyArray();
      });
